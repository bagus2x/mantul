...
const MapBasic = dynamic(
  () =>
    import('@mantul/app/[locale]/(admin)/map/components/map-basic').then(
      (module) => module.MapBasic,
    ),
  { ssr: false },
)
...
const MapCirclePolygon = dynamic(
  () =>
    import('@mantul/app/[locale]/(admin)/map/components/map-circle-polygon').then(
...
const MapMarker = dynamic(
  () =>
    import('@mantul/app/[locale]/(admin)/map/components/map-marker').then(
