  ...
  return (
    <Card className={cn('flex flex-col gap-4 p-4', className)}>
      ...
      <EditorContent
        editor={editor}
        className={cn(
          'w-full rounded-md border border-dashed p-4 outline-none',
          editor?.isFocused && 'border-2',
        )}
      />
    </Card>
  )
