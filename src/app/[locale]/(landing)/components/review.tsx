...
export const Review = ({ className }: ReviewProps) => {
  return (
    <BlurFade
      ...
      <div className='pointer-events-none absolute inset-y-0 start-0 w-1/3 bg-gradient-to-r from-white dark:from-background'></div>
      <div className='pointer-events-none absolute inset-y-0 end-0 w-1/3 bg-gradient-to-l from-white dark:from-background'></div>
