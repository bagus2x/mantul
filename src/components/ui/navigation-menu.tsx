...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      'data-[motion=from-end]:slide-in-from-end-52 data-[motion=to-end]:slide-out-to-end-52 data-[motion=from-start]:slide-in-from-start-52 data-[motion=to-start]:slide-out-to-start-52 start-0 top-0 w-full data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out md:absolute md:w-auto',
      className,
    )}
    {...props}
  />
