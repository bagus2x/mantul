...
import { Drawer, DrawerContent } from '@mantul/component/ui/drawer'
import { Link } from '@mantul/component/ui/link'
import { Separator } from '@mantul/component/ui/separator'
import { useMediaQuery } from '@mantul/lib/hook/use-media-query'
import { useToggle } from '@mantul/lib/hook/use-toggle'
          ...
          <div
            className={cn(
              ...
              menu.href &&
                ...
                'bg-primary/15 font-bold text-primary/80 hover:bg-primary/15',
            )}
  ...
  return (
    <div className='flex flex-col space-y-2 overflow-hidden'>
      <LinkItem>
        ...
        {true && (
          <span className='flex-1 overflow-hidden text-ellipsis text-nowrap'>{menu.title}</span>
        )}
        {menu.menus?.length && (
          <ChevronRightIcon
...
export const SidebarContent = () => {
  ...
  return (
    <div className='overflow-hidden px-2'>
      <div className={cn('flex h-16 items-center space-x-2 px-2')}>
        <Image
          src='/mantul.svg'
          width={32}
          height={32}
